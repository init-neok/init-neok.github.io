...
I am a Master student in [Xi'an Jiaotong University](http://en.xjtu.edu.cn/). Also I am a member of **SICDP**(Lab of **S**ocial **I**ntelligence and **C**omplex **D**ata **P**rocess) and am supervised by [Prof. Rao](https://gr.xjtu.edu.cn/en/web/raoyuan/7). My research interests lie in :
  - ![Static Badge](https://img.shields.io/badge/Natural_Language_Processing%20-NLP-blue?style=flat)

  - ![Static Badge](https://img.shields.io/badge/Data_Mining-8A2BE2?style=plastic)

  - ![LLMs](https://img.shields.io/badge/-LLMs-orange) Large Language Models (LLMs) and practical methods using LLMs
